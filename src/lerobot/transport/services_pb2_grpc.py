...
class LearnerServiceStub:
    """LearnerService：Actor 调用此服务来推送转移（transition）。
    该服务由 Learner 实现。
    """
...
class AsyncInferenceStub:
    """AsyncInference：从 Robot 的视角
    Robot 向远程 Policy 服务器发送观测，并执行从其接收到的动作
    """
...
class AsyncInferenceServicer:
    ...
    def SendObservations(self, request_iterator, context):
        """Robot -> Policy，与远程推理服务器共享观测
        Policy -> Robot，共享针对给定观测预测出的动作
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
